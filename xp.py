...
"""
import discord
from config import MULTIPLIER_ROLE_SET, LEVEL_COIN_BONUSES
from data import xp_data, add_coins, save_xp_data, get_level, get_xp
from utils import next_level_requirement, update_roles_on_level
